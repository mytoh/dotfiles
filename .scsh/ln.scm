...
(define dotfiles (list ".emacs" ".emacs-w3m" ".twmrc" ".cshrc" ".vim" ".gtkrc-2.0" ".screenrc" ".xinitrc" ".stumpwmrc" ".vimrc" ".vimperatorrc" ".sawfishrc" ".Xresources"))
...
(let loop ((f dotfiles))
  (if (null? f)
	...
	(display (string-append "linked " (car f)))
	(newline)
        (loop (cdr f)))))
