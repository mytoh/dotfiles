...
(define (update-cpu-loads)
  (call-for-each-line-in-file "/usr/compat/linux/proc/stat"
    (lambda (line break)
...
(define (update-mem-loads)
  (let* ((file (file->string "/usr/compat/linux/proc/meminfo"))
...
(define (update-net-loads)
  (call-for-each-line-in-file "/usr/compat/linux/proc/net/dev"
    (lambda (line break)
